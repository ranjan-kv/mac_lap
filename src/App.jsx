  ...
  return (
    <div className="w-full h-screen bg-black font-['Helvetica_Now_Display']">
      <div className="navbar line flex gap-10 pt-10 pb-3 absolute top-0 left-1/2 -translate-x-1/2">
        {["iphone", "ipad", "services", "center", "mac", "ios", "ipad"].map((e) => (
          <a key={e} href="" className="text-white font-[400] text-md capitalize">{e}</a>
        ))}
      </div>
      <div className="absolute flex flex-col items-center text-white top-[100px] left-1/2 -translate-x-1/2">
        <h3 className="masked text-7xl tracking-tighter font-[700]">macbookpro</h3>
        <h5>Ranjan</h5>
      </div>
